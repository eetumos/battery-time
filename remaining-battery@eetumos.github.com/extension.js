...
const RemainingBatteryIndicator = GObject.registerClass(
class RemainingBatteryIndicator extends SystemStatus.Indicator {
    _sync() {
        super._sync();
...
export default class RemainingBatteryExtension extends Extension {
    install() {
        this.indicator = new RemainingBatteryIndicator();
